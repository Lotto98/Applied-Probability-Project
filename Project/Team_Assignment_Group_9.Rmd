...
$$
\mathbb{P}[X_i \geq 1] = \sum \limits_{x = 0}^ \infty \mathbb{P}[X_i \geq 1, X = x]  \\ = \sum \limits_{x = 0}^ \infty \mathbb{P}[X = x] - \mathbb{P}[X_i = 0, X = x] \\ = \sum \limits_{x = 0}^ \infty \mathbb{P}[X = x] - \sum \limits_{x = 0}^ \infty \mathbb{P}[X_i = 0, X = x] \\ = \sum \limits_{x = 0}^ \infty (1 - P_1)^x P_1 - \sum \limits_{x = 0}^ \infty (1 - P_1 - P_i)^xP_1
$$
