...
$$
P_{n}^{n_1,n_2,...,n_k} = P_{12}^{2,2,..,2} = \frac{12!}{(2!)^6} = \frac{12!}{2^6}
$$
...
$$
P[\text{each outcome exactly twice}] = \frac{12!}{2^6} \cdot (P_X(X = 0))^6 \cdot (P_X(X = 1))^6 = \frac{12!}{2^6} \cdot \bigg(\frac{1}{3}\bigg)^6 \cdot \bigg(\frac{2}{3}\bigg)^6 
$$
...
$$
E[B] = E[\sum \limits_{i = 2}^r Y_i] = \sum \limits_{i = 2}^r E[Y_i] = \sum \limits_{i = 2}^r P[Y_i = 1] = \sum \limits_{i = 2}^r \frac{P_i}{P_1 + P_i} 
$$
