...
<!--And finally we draw a picture in order to have a visual understanding of the subdivision of all probabilities:-->
...
* \(B_{I^c \cap II \cap III} = \)\{\text{People who read the newspaper }II\text{ and }III\text{ but not }I\}
* \(B_{I \cap II^c \cap III} = \)\{\text{People who read the newspaper }III\text{ and }I\text{ but not }II\}
* \(B_{I \cap II \cap III} = \)\{\text{People who read the newspaper }I\text{, }II\text{ and }III\}
...
\[f_{X}(x,y) = \int_a^b f_{X,Y}(x,y) \,dy = \int_0^1 (x + y) \,dy = \Bigg[xy + \frac{y^2}{2}\Bigg]_0^1 = \Bigg(x + \frac{1}{2} \Bigg)\]
\[f_{Y}(x,y) = \int_a^b f_{X,Y}(x,y) \,dx = \int_0^1 (x + y) \,dx = \Bigg[xy + \frac{x^2}{2}\Bigg]_0^1 = \Bigg(y + \frac{1}{2} \Bigg)\]
And
\[f_{X}(x,y) \times f_{Y}(x,y) = \Bigg(x + \frac{1}{2} \Bigg) \cdot \Bigg(y + \frac{1}{2} \Bigg) = \frac{4xy + 2x +y +1}{4} \neq f_{X,Y}(x,y)\]
...
$$
P[\text{each outcome exactly twice}] = \frac{12!}{2^6} \cdot (\frac{1}{3})^6 \cdot (\frac{2}{3})^6 
$$
...
$$
p = \frac{12!}{4! 4!4!} \cdot (\frac{1}{3})^{12}
$$
